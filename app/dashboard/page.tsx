                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 xl:grid-cols-5 gap-3">
                    {[
                      ...
                      { href: '/studio', label: 'Studio Console', icon: (
                        <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75L3.75 12l4.5 5.25m7.5-10.5L20.25 12l-4.5 5.25M13.5 4.5l-3 15" />
                        </svg>
                      ), color: '#8b5cf6' },
                      { href: '/ops', label: 'Ops Console', icon: (
                        <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
