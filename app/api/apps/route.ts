...
export async function POST(request: NextRequest) {
  try {
    ...
    const app = await publishAgentApp({
      ...
      logoUrl: stringBodyValue(body, 'logoUrl', 'logo_url') ?? null,
      bannerUrl: stringBodyValue(body, 'bannerUrl', 'banner_url') ?? null,
      videoUrl: stringBodyValue(body, 'videoUrl', 'video_url') ?? null,
      websiteUrl: stringBodyValue(body, 'websiteUrl', 'website_url') ?? null,
      documentationUrl: stringBodyValue(body, 'documentationUrl', 'documentation_url') ?? null,
      supportUrl: stringBodyValue(body, 'supportUrl', 'support_url') ?? null,
      privacyPolicyUrl: stringBodyValue(body, 'privacyPolicyUrl', 'privacy_policy_url') ?? null,
      termsUrl: stringBodyValue(body, 'termsUrl', 'terms_url') ?? null,
      pricing: body.pricing,
      releaseNotes: stringBodyValue(body, 'releaseNotes', 'release_notes') ?? null,
      changelog: body.changelog,
      gallery: body.gallery,
      mediaAssets: body.mediaAssets ?? body.media_assets,
      rejectionReason: stringBodyValue(body, 'rejectionReason', 'rejection_reason') ?? null,
