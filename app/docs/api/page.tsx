...
const endpoints: Endpoint[] = [
  {
    ...
    response: '{ "status": "ok", "version": "6.6.8", "timestamp": "...", "tools": 44 }',
  },
  {
  ...
  },
  {
    ...
    desc: 'Read the disabled FFP compatibility status. All runtime execution bypasses FFP in V6.6.8.',
  ...
  },
  {
    ...
    desc: 'Returns 405 Method Not Allowed. FFP cannot be activated in V6.6.8.',
    body: [
  ...
  },
  {
    ...
    desc: 'Browse the V6.6.8 Skill Store marketplace with ranked search, categories, installed state, grouped discovery rows, recommendations, and developer spotlight.',
    response: '{ "skills": [...], "categories": ["Intelligence", "Research"], "installedSlugs": [], "sections": [...] }',
  },
  {
  ...
  },
  {
    ...
    desc: 'Browse the V6.6.8 App Store with ranked search, installed priority, hero apps, featured, trending, recommended, new releases, recently updated, top installed, category rows, and developer spotlight.',
