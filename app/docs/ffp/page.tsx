      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-10">
        <section>
          ...
          <p className="text-lg text-gray-500">
            AgentOS v6.6.7 retains FFP compatibility data, but all runtime execution bypasses FFP. No activation control, consensus engine, validator voting, or proposal history is available.
          </p>
        </section>
        ...
        <section className="card p-6">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <p>All execution types bypass FFP in v6.6.7.</p>
          </div>
        </section>
