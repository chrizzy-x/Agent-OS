...
const buckets: AuditBucket[] = [
  {
    title: 'Implemented',
    items: [
      'Super AgentOS Studio remains intact while workspace IA now separates Projects, Workflows, Library ownership, App Store discovery, Developer, FFP, and Settings.',
      'Versioned public surfaces now align on AgentOS V6.6.4 and the canonical production host.',
      'Universal search covers projects, apps, skills, subagents, workflows, chats, memory, Library assets, connectors, and Vault names only.',
