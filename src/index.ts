...
async function handleFFPConsensus(req: IncomingMessage, res: ServerResponse, privateRef: string): Promise<void> {
  ...
  sendJson(res, 501, {
    ...
    message: `FFP consensus history is disabled and Coming Soon in V6.6.8 for ${privateRef}.`,
  });
}
...
function handleFFPStatus(_req: IncomingMessage, res: ServerResponse): void {
  sendJson(res, 200, {
    ...
    consensusAvailable: false,
    message: 'FFP is disabled and Coming Soon in V6.6.8. All runtime execution bypasses FFP.',
  });
}
