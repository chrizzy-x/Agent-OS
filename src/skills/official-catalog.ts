...
export const OFFICIAL_SKILL_PACKS: OfficialSkillPack[] = [
  ...
  {
    slug: 'intelligence-and-evals',
    name: 'Intelligence and Evals',
    description: 'Prompt prep, evaluation, labeling, and heuristic classification utilities for intelligence workflows.',
    categories: ['Intelligence & Evals'],
  },
  {
...
export const OFFICIAL_VERIFIED_SKILLS: OfficialSkillEntry[] = [
  ...
  { slug: 'prompt-toolkit', name: 'Prompt Toolkit', category: 'Intelligence & Evals', pack: 'intelligence-and-evals', summary: 'Extract variables, generate prompt variants, and inspect prompt structure.' },
  { slug: 'eval-scorecard', name: 'Eval Scorecard', category: 'Intelligence & Evals', pack: 'intelligence-and-evals', summary: 'Calculate pass rates and weighted evaluation summaries.' },
  { slug: 'classifier-heuristics', name: 'Classifier Heuristics', category: 'Intelligence & Evals', pack: 'intelligence-and-evals', summary: 'Label common workflow items with deterministic classifier rules.' },
  { slug: 'embedding-prep', name: 'Embedding Prep', category: 'Intelligence & Evals', pack: 'intelligence-and-evals', summary: 'Estimate tokens and prepare content for embedding pipelines.' },
  { slug: 'dataset-labeler', name: 'Dataset Labeler', category: 'Intelligence & Evals', pack: 'intelligence-and-evals', summary: 'Count labels and enforce dataset annotation consistency.' },
