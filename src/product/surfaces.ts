...
export const PRODUCT_SURFACES: readonly ProductSurface[] = [
  ...
  { id: 'appstore', label: 'App Store', title: 'App Store', href: '/appstore', icon: 'A', access: 'signed_in', status: 'active', mobileVisibility: 'drawer', required: true, navigation: true, primaryAction: { label: 'Install', href: '/appstore' } },
  { id: 'skillstore', label: 'Skill Store', title: 'Skill Store', href: '/skillstore', icon: 'K', access: 'signed_in', status: 'active', mobileVisibility: 'drawer', required: true, navigation: true, aliases: ['/skills'], primaryAction: { label: 'Install', href: '/skillstore' } },
