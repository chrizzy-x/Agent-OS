...
export type MarketplaceAssetType = 'app' | 'skill';
...
function librarySourceType(assetType: MarketplaceAssetType): 'installed_app' | 'installed_skill' {
  return assetType === 'app' ? 'installed_app' : 'installed_skill';
}
